...
- Organize files from top to bottom. The file entry point should be at the very top. More deeply nested functions and components should be lower down in the file.
